...
public class EmployeeResource {
	...
	@PostMapping(consumes={"application/xml","application/json"},produces="text/plain")
	...
	@PutMapping(value="/{id}",consumes={"application/xml","application/json"}, produces="text/plain")
	public ResponseEntity<String> updateEmployee(@RequestBody Employee e, @PathVariable("id") int id) {
